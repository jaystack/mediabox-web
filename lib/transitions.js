...
export const slideBiDirectionalTransition = (duration, amount) => ({
  initial: { x: -amount, opacity: 0, transition: { duration, ease: easing } },
  exit: { x: amount, opacity: 0, transition: { duration, ease: easing }, position: 'absolute' },
  initialReverse: { x: amount, opacity: 0, transition: { duration, ease: easing } },
  exitReverse: { x: -amount, opacity: 0, transition: { duration, ease: easing }, position: 'absolute' },
  enter: {
    x: 0,
    opacity: 1,
    transition: { delay: 0, duration, ease: easing },
